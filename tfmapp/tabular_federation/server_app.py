import torch
from tfmapp.tabular_federation.strategy import CustomFedAvg
...
from tfmapp.tabular_federation.utils.task_tabular import get_weights, MLP
...
# Nueva función de agregación de métricas
# def average_metrics(metrics):
#     """Calcula el promedio de accuracy, recall, precision y f1-score."""
...
#         "federated_recall": avg_recall,
#         "federated_precision": avg_precision,
#         "federated_f1score": avg_f1
#     }
...
def server_fn(context: Context):
    ...
    # model = MLP(input_size=21, num_classes=3)
